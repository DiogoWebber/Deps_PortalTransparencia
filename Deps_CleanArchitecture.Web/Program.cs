...
try
{
    ...
    // Adiciona o contexto e JWT usando métodos de extensão
    builder.Services.AddDbContext(); // Adiciona contextos ao serviço
    builder.Services.ConfigureJwt(); // Configura JWT
    ...
    builder.Host.ConfigureContainer<ContainerBuilder>(containerBuilder =>
    {
        ...
        StartupSetup.ConfigureContainer(containerBuilder); // Adiciona a configuração do StartupSetup
    });
